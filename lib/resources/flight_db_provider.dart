  ...
  _initDB() async{
    ...
    var db = await openDatabase(
        ...
        onCreate: (Database newDb, int version){
          newDb.execute(
           "CREATE TABLE $tableName($columnId INTEGER PRIMARY KEY,$columnfullname TEXT,$columnemail TEXT,$columncontact TEXT, $columnsource TEXT, $columnnumber TEXT,$columndate TEXT,$columndestination TEXT)"
          );
        },
    );
    return db;
